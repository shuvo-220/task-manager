...
import { LINK_CLASSES, menuItems, PRODUCTIVITY_CARD, SIDEBAR_CLASSES, TIP_CARD } from '../assets/dummyData'
      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className='p-5 border-b border-purple-100 lg:block hidden'>
          <div className='flex items-center gap-3'>
            <div className='w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center text-white font-white shadow-md'>
              {intial}
            </div>
            ...
            <div>
              ...
              <p className='text-sm text-purple-500 font-medium flex items-center gap-1 '>
                <Sparkles className='w-3 h-3 ' />Lets Curse Some Task.
              </p>
            </div>
          ...
          <div className='mt-auto pt-6 lg:block hidden'>
            <div className={TIP_CARD.container}>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <h3 className={TIP_CARD.title}><span className='text-purple-700'>Pro Tip</span></h3>
                  <p className={TIP_CARD.text}><span className='text-purple-500'>Use keyboard shortcut to boost productivity.</span></p>
                </div>
              </div>
            </div>
          </div>
